					...
					<table class="table table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<td><?php echo 'R'.$item["price"].' ZAR'; ?></td>
							...
							<tr>
								...
								<td class="text-right"><strong><?php echo 'R'.$cart->total().' ZAR'; ?></strong></td>
								<td></td>
							</tr>
							<?php } ?>
						</tbody>
			...
			<div class="col mb-2">
				<div class="row">
					...
					<div class="col-sm-12 col-md-6 text-right">
						<?php if($cart->total_items() > 0){ ?>
						<a href="checkout.php" class="btn btn-lg btn-block btn-primary">Continue to Place Order</a>
						<?php } ?>
					</div>
				</div>
			</div>
